...
func (dh *DataHandler) Publish(r *http.Request) (msg string, code int, err error) {
	...
	if err := sqlmodel.DataUpsert(r.Context(), dh.db, dh.client.deployment.Model.ID, d); err != nil {
...
func (dp *DataProcessor) Run() (err error) {
	...
	if err := sqlmodel.DataSetStatusProcessed(ctx, txn); err != nil {
...
func DataProcessorSkip(ctx context.Context, db *sql.Connection, d *model.Data) (err error) {
	return sqlmodel.DataSetStatus(ctx, db, model.DataStatusPending, d)
}
