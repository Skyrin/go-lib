...
-- Defines the sync_item table
CREATE TABLE IF NOT EXISTS sync_item (
	sync_item_id BIGSERIAL PRIMARY KEY NOT NULL,	
    item_id BIGINT NOT NULL, -- The ID for the object being pushed
	item TEXT NOT NULL, -- Object to push
...
CREATE TABLE IF NOT EXISTS sync_queue (
	...
	created_on TIMESTAMP NOT NULL,
	updated_on TIMESTAMP NOT NULL,
	CONSTRAINT sync_queue_index__object_id__service__ukey UNIQUE (sync_queue_index, sync_queue_object_id, sync_queue_service)
);
